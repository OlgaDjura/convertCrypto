...
<template>
  ...
  <Favorite :favs="favs" v-if="favs.length > 0" :getFromFavs="getFromFavs"></Favorite>
  <div className="selectors">
  <Selector :setCrypto="setCryptoFirst" :cryptoNow="cryptoFirst"></Selector>
  <Selector :setCrypto="setCryptoSecond" :cryptoNow="cryptoSecond"></Selector>
</div>
</body>
</template>
